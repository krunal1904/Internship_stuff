...
print("% of plagiarism= total frequency of common words/ max(len(file)")
total=0
for i,j in plagiarisam.items():
  total=total+j

print("total frequency of common words is:-",total)
if len(content_list)>len(content1_list):
  max=len(content_list)
else:
  max=len(content1_list)
print("max lenght of file is:",max)

percentage=(total/max)*100
print("% of plagiarism:-",percentage)